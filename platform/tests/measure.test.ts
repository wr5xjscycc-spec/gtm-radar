...
describe("pure helpers — buildSeedQueries + candidate pool", () => {
  it("buildSeedQueries: defaults to 6, caps at 8, floors at 1, keyword-sourced, embeds vertical", () => {
    ...
    expect(buildSeedQueries("v", 100)).toHaveLength(8); // cap
    expect(buildSeedQueries("v", 0)).toHaveLength(6); // 0 → default
